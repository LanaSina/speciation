...
public class EmbodiedStarter {
	...
	public static void main(String[] args) {
		...
		//array of energy dissipation properties
		/*int nEnergies = Constants.EnergyTypes;
		Energy[] energies = new Energy[nEnergies];		
		//light: visible 6 cells away
		//dissipation function should depend on map
		energies[0] = new Energy(0,6);
		//sound
		energies[0] = new Energy(0,3);
