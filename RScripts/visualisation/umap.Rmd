...
```{r}
file_number <- 75000L
base_path <- sprintf("/Users/hyoyeon/Desktop/Career/Sony/Lana/2024_12_29_17_15/OEE-data/SummaryIndividuals_%d.csv", file_number)
...
out_path <- sprintf("umap_res/umap_res_%d.csv", file_number)
write.csv(cluster_output, out_path, row.names = FALSE)
