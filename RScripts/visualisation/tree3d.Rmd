  ...
  fig <- plot_ly(
    ...
    layout(
      ...
      scene = list(
        ...
        dragmode = "turntable",
        # view 
        # (ref: https://stackoverflow.com/questions/78598698/changing-view-angle-in-a-3d-plotly-plot 
        # and https://plotly.com/python/3d-camera-controls/)
        camera = list(
          # Up vector
          up=list(x=0, y=0, z=1),
          # Look-at point
          center=list(x=0, y=0, z=0),
          # created, pgmDeath, maxEnergy
          eye=list(x=1.5, y=-0.5, z=0.5) # Camera position
        )
      ),
      margin = list(l = 0, r = 0, b = 0, t = 0)
    ) %>%
    # animation
    animation_opts(frame = 500, transition = frame, easing = "linear", redraw = FALSE, mode = "immediate") %>%
...
# Example call (uncomment to run)
 ...
 time_range <- c(0, 75000L)
 fig <- plot_summary_tree(
   folder_path   = "../../../Lana/2024_12_29_17_15/OEE-data/",
   ...
   keep_parents  = FALSE,
   sample_frac   = 0.004,
   out_file      = file.path(OUT_DIR, paste0(folder_name, "_summary_", TRAIT_Y, "_", TRAIT_Z, "_3d.html"))
 )
```
